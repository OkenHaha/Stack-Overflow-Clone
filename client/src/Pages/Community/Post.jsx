...
const Post = () => {
	...
	return (
		<div className="card">
			<div className="top">
				<div className="userDetails">
					<div className="profile_img">
						<img src="https://w7.pngwing.com/pngs/831/88/png-transparent-user-profile-computer-icons-user-interface-mystique-miscellaneous-user-interface-design-smile-thumbnail.png" className="cover"/>
					</div>
					<h3>Online<br/><span>Patna, India</span></h3>
				</div>
				<div class="dot">
			...
			<div className="imgBx">
				<img src="https://www.91-cdn.com/hub/wp-content/uploads/2022/05/Instagram-logo-1200x900.jpg" className="cover"/>
			</div>
			...
			<h4 className="likes">1231 Like,</h4>
			<h4 className="message"><b>Oline_b</b> Thanks for the support! <span>#mern</span></h4>
			<h4 className="comments">Viel all comments</h4>
			<div className="addComments">
				<div className="userImg">
					<img src="https://w7.pngwing.com/pngs/831/88/png-transparent-user-profile-computer-icons-user-interface-mystique-miscellaneous-user-interface-design-smile-thumbnail.png" className="user"/>
				</div>
				<input type="text" class="text" placeholder="Add a comment"/>
			</div>
			<h5 className="postTime">4 hrs ago</h5>
		</div>
	)
}
